$(function() {
    ...
    var $facebookButton = $('facebook_image_button');
    ...
    function getListFromNumber(number) {
        return {
            headListItem: $('.tag_list > li#requestNumber-' + number + ''),
            loadingImage: $('.tag_list > li#requestNumber-' + number + ' > .content > ul > img'),
            placeToAdd: $('.tag_list > li#requestNumber-' + number + ' > .content > ul'),
            tagArea: $('.tag_list > li#requestNumber-' + number + ' > .tagImages')
        };
    }
    ...
    $submitButton.click(function() {
        ...
        var tags = "<li id='requestNumber-" + 
                    requestCounter + 
                    "'><div class='tagImages'><img src=" + 
                    url + 
                    " /></div><div class='content'><ul><img src='ajax-loader.gif'/></ul></div></li>"
        $resultsList.append(tags);

        socket.emit('FindPhotoTags', {
            'url': url,
